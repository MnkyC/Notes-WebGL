...
function main() {
  ...
  draw(gl, n, u_ViewMatrix, viewMatrix);   // 绘制 Draw
}
...
var g_eyeX = 0.20, g_eyeY = 0.25, g_eyeZ = 0.25; // 视点 Eye position
function keydown(ev, gl, n, u_ViewMatrix, viewMatrix) {
  if (ev.keyCode == 39) { // 按下右键 The right arrow key was pressed
    g_eyeX += 0.01;
  } else
    if (ev.keyCode == 37) { // 按下左键 The left arrow key was pressed
      g_eyeX -= 0.01;
    } else { return; }
